  ...
  useEffect(() => {
    if (searchTerm.trim() === '') {
      ...
      const filtered = flights.filter(flight => {
        const airportName = (flight.arrival?.airport || '').toLowerCase();
        const airportIata = (flight.arrival?.iata || '').toLowerCase();
  ...
  return (
    <div className="min-h-screen flex flex-col">
      ...
      <main className="flex-1 max-w-7xl w-full mx-auto px-4 sm:px-6 lg:px-8 py-8">
        <div className="mb-8">
          <h1 className="text-3xl font-bold text-gray-900 mb-2">Search by Destination</h1>
          <p className="text-gray-500">Find flights heading to your desired arrival airport.</p>
        </div>
        ...
        <div className="mb-8 max-w-xl">
          <div className="relative">
            ...
            <input
              type="text"
              placeholder="Search by Arrival Airport (e.g. Heathrow, LHR)"
